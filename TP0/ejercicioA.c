...
/*
  ...
  a) Los datos tienen d inputs, todos valores reales, correspondientes a la 
     ...
     normal, con centro en el ( 1, 1, 1, .... , 1 ) y matriz de covarianza 
     diagonal, con desviación estándar igual a C * SQRT(d). La clase 0 tiene 
     la misma distribución, pero centrada en el ( -1, -1, -1, .... , -1 ). 
  ...
  $ gcc -Wall ejercicioA.c -o ejercicioA -lm
  $ ./ejercicioA n d C
  Ejemplo:
  $ ./ejercicioA 100 2 2.1
